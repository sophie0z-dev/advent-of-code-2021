...
describe('helpers', () => {
  ...
  describe('checkBoard', () => {
    test('should return true if board has a marked row', () => {
      const board: Board = {
        boardNumbers: new Array(25).fill(null).map((x: BoardNumber, i: number) => ({ number: i, marked: i < 5 })),
        hasWon: false,
      }
    ...
    test('should return false if board does not have a marked row', () => {
      const board: Board = {
        boardNumbers: new Array(25).fill(null).map((x: BoardNumber, i: number) => ({ number: i, marked: false })),
        hasWon: false,
      }
    ...
    test('should return true if board has a marked column', () => {
      const board: Board = {
        boardNumbers: new Array(25).fill(null).map((x: BoardNumber, i: number) => ({ number: i, marked: i % 5 === 0 })),
        hasWon: false,
      }
